const FeaturesAndInBox = ({ product }) => {
  return (
    <section className='grid d:grid-cols-7 d:items-start gap-28 d:gap-0'>
      <article className='grid d:col-span-4 justify-items-start text-left gap-5'>
      ...
      <article className='grid t:grid-cols-2 d:grid-cols-1 d:col-span-3 d:justify-self-center justify-items-start gap-5'>
